import deliveryTruckImg from '../Icons/delivery-truck.svg'
import headphoneTruckImg from '../Icons/headphone.svg'
...
const FeaturesTab = () => {
  return ( <div className="bg-white  w-full grid justify-center gap-8 px-4 py-12
    ...
    <div className='flex gap-4 items-center '>
      <img src={headphoneTruckImg} className='max-w-8' />
      <div>
    ...
    <div className='flex gap-4 items-center'>
      <img src={shoppingBagImg} className='max-w-8' />
      <div>
    ...
    <div className='flex gap-4 items-center'>
      <img src={packageImg} className='max-w-8' />
      <div>
